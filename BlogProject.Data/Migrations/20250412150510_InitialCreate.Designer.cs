...
namespace BlogProject.Data.Migrations
{
    ...
    [Migration("20250412150510_InitialCreate")]
            ...
            modelBuilder.Entity("BlogProject.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "32ee1f39-01d4-49b1-b4cc-630cc8fd3bab",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4b3c0884-f788-4862-a139-7d4891c868cb",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "73c71e77-be5e-4122-aad3-c50a557ca640",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("BlogProject.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0a705150-cc3e-47cd-8d10-4dfc260c5cc1",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDc8bEFcpuLpQb0ciYpdzsstHupGOzkANJ/XCemikbURfinZe7wk+uAYg5KAeSc9GQ==",
                            PhoneNumber = "+905439999999",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "5cdbf13d-2312-4dd7-9e04-f957f756a746",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "dedc1e37-bec7-4a77-9aa0-c53d03a57cd7",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEATNb2+SNiLgi5Gc8sR7OOaq8ZIRdNEqSlPhXTL+odAw5faMTezpwd6YNRQ8vLwkdw==",
                            PhoneNumber = "+905439999988",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0ed4a048-bc01-433b-bbc3-0069708b9cfd",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BlogProject.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aec6e950-c38d-4ce6-beb3-7c74e237f806"),
                            ...
                            CreatedDate = new DateTime(2025, 4, 12, 18, 5, 9, 616, DateTimeKind.Local).AddTicks(6249),
                            ImageId = new Guid("f71f4b9a-aa60-461d-b398-de31001bf214"),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("bb86c245-b885-45f0-b6ef-80bfe7e6e394"),
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 4, 12, 18, 5, 9, 616, DateTimeKind.Local).AddTicks(6265),
                            ImageId = new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("BlogProject.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 4, 12, 18, 5, 9, 617, DateTimeKind.Local).AddTicks(1928),
                            IsDeleted = false,
                            Name = "ASP.NET Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 4, 12, 18, 5, 9, 617, DateTimeKind.Local).AddTicks(1932),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("BlogProject.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 4, 12, 18, 5, 9, 617, DateTimeKind.Local).AddTicks(3141),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 4, 12, 18, 5, 9, 617, DateTimeKind.Local).AddTicks(3145),
